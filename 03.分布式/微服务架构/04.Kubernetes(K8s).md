...
![部署示意图](04.Kubernetes(K8s).assets/image-20220508220022552.png)
...
![部署示意图](04.Kubernetes(K8s).assets/kwob90mh.png)
...
* 重要概念 Pod
  ...
  <img src="04.Kubernetes(K8s).assets/kwoccq7d.jpeg" alt="集群示意图.png" style="zoom:80%;" />
...
* Kubernetes 组件
  ...
  ![Kubernetes组件](04.Kubernetes(K8s).assets/kwonmx7e.png)
...
- **裸机安装（Bare Metal）**
  ...
  <img src="04.Kubernetes(K8s).assets/image-20220517112053103.png" alt="image-20220517112053103" style="zoom:50%;" />
...
- 登录阿里云控制台 - 产品搜索 Kubernetes
  ...
  <img src="04.Kubernetes(K8s).assets/image-20220517111817845.png" alt="image-20220517111817845" style="zoom:67%;" />
...
5. 安装网络组件（主节点跑）
   ...
   * calico
     ...
     [root@vm21 ~]# kubectl get nodes
     NAME   STATUS   ROLES                  AGE     VERSION
     vm21   Ready    control-plane,master   6m19s   v1.23.5
     vm22   Ready    <none>                 5m31s   v1.23.5
     vm23   Ready    <none>                 5m23s   v1.23.5
     ```
...
6. 安装 Dashboard（master 节点）
   ...
   * 手动生成yaml文件
     ...
     <img src="04.Kubernetes(K8s).assets/image-20220518114048970.png" alt="image-20220518114048970" style="zoom:80%;" />
     ...
     ![image-20220518114839985](04.Kubernetes(K8s).assets/image-20220518114839985.png)
...
* Deployment 通过 label 关联起来 Pods
  ...
  ![deployment.png](04.Kubernetes(K8s).assets/kwpt8p8o.png)
...
![service简单示意图.png](04.Kubernetes(K8s).assets/kwpuoh0h.png)
...
![kubernetes service](04.Kubernetes(K8s).assets/kwvie6pw.png)
查看服务详情 `kubectl describe svc test-k8s`，可以发现 Endpoints 是各个 Pod 的 IP，也就是他会把流量转发到这些节点。
![kubernetes endpoints](04.Kubernetes(K8s).assets/kwvifqes.png)
...
![statefulset.png](04.Kubernetes(K8s).assets/kwrhzaku.png)

Endpoints 会多一个 hostname
![endpoints](04.Kubernetes(K8s).assets/kwri1g2g.png)
...
![mongodbweb.png](04.Kubernetes(K8s).assets/kwriial2.jpeg)

![image.png](04.Kubernetes(K8s).assets/kwripe9o.png)
...
<img src="04.Kubernetes(K8s).assets/kwrmidne.png" alt="持久卷" style="zoom:80%;" />
...
![腾讯云创建kubernetes pvc](04.Kubernetes(K8s).assets/kwvrj64s.png)
...
![configmap.png](04.Kubernetes(K8s).assets/kwubdzyw.png)
...
![image.png](04.Kubernetes(K8s).assets/kwub4een.png)
...
![image.png](04.Kubernetes(K8s).assets/kwudup5z.png)
...
![2.png](04.Kubernetes(K8s).assets/kwhd6dc8.png)
...
![腾讯云 ingress](04.Kubernetes(K8s).assets/kwvrrepn.png)
